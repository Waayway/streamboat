...
impl State {
    pub fn from_settings(settings: &Settings, key_location: String) -> Self {
        ...
        Self {
            ...
            play_reporting_enabled: settings.play_reporting_enabled,
    ...
    pub fn apply_to(&self, settings: &mut Settings) -> OutputConfig {
        ...
        settings.play_reporting_enabled = self.play_reporting_enabled;
...
mod tests {
    ...
    fn play_reporting_defaults_to_enabled_per_d027() {
        ...
        assert!(settings.play_reporting_enabled);
    }
}
